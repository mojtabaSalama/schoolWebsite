    ...
    -->
    	<div class="sidebar-wrapper">
            ...
            <ul class="nav">
                <li >
                    <a href="/admin">
                        <i width="16" height="16" class="fa fa-dashboard"></i>
                        <p>Dashboard</p>
                    </a>
                </li>
                <li>
    ...
    <div class="main-panel">
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                ...
                -->
                    ...
                    <a class="navbar-brand navbar-left text-dark" href="/admin"> 
        ...
        <!-- <footer class="footer">
            <div class="container-fluid text-center">
              <p class="text-center">All rights reserved &copy; MANGA<sup>TM</sup></p>
            </div>
        </footer> -->
